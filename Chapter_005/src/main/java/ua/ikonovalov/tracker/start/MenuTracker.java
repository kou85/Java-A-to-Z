...
public class MenuTracker {
     ...
     */
    private List<UserAction> actions = new ArrayList<>(9);
   // private UserAction[] actions = new UserAction[9];
    ...
    public void fillAction() {
        ...
        this.actions.add(this.new DeleteAllItem(4, "Delete All Item."));
        this.actions.add(this.new FindItemByName(5, "Find Item by name."));
        this.actions.add(this.new FindItemById(6, "Find Item by ID."));
        this.actions.add(this.new AddComment(7, "Add comments."));
       ...
       // this.actions[position++] = new ShowItems(1, "Show all items.");
        ...
        //this.actions[position++] = this.new DeleteAllItem(4, "Delete All Item.");
        //this.actions[position++] = this.new FindItemByName(5, "Find Item by name.");
        //this.actions[position++] = this.new FindItemById(6, "Find Item by ID.");
        //this.actions[position++] = this.new AddComment(7, "Add comments.");
    }
    ...
    private class DeleteAllItem extends BaseAction {
         ...
         * @param nameAction name action.
         */
        private DeleteAllItem(int keyAction, String nameAction) {
            super(keyAction, nameAction);
        }

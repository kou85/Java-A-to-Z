...
public class Board {
    ...
    /**
     * Method getFigure obtaining the figures.
    ...
    boolean move(Cell source, Cell dist) throws ImpossibleMoveException, OccupiedWayException, FigureNotFoundException {
        if (!(dist.getCoordinateX() > maxPivot || dist.getCoordinateX() < minPivot || dist.getCoordinateY() > maxPivot || dist.getCoordinateY() < minPivot)) {
